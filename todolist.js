...
function createLiElement(id, title, descrition) {
	...
	liEl.querySelector('.titleInput').addEventListener('change', function () {
		titleHandler(this.value, this.previousElementSibling.value);
	});
	liEl.querySelector('.areaDescrip').addEventListener('change', function () {
		descriptionHandler(this.value, this.parentElement.children[1].value);
	});
	liEl.querySelector('.arrow_Up').addEventListener('click', function () {
		moveFunc(this, this.parentElement, this.nextElementSibling.value);
	});
	liEl.querySelector('.arrow_Down').addEventListener('click', function () {
		moveFunc(
			this,
			this.parentElement,
	...
	liEl.querySelector('.binButton').addEventListener('click', function () {
		removeLi(
